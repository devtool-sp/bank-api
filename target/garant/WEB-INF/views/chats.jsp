				...
				<div class="b-popup-chats main-subsection">
					<div class="b-popup-content-chats">
						<div class="chats-contacts">
							<div class="chats-contact-add-btn">+Добавить контакт</div>
							<div class="chats-contact">
								<div class="chats-contact-name">Имя</div>
								<div class="chats-contact-status">0</div>
								<div class="chats-contact-last-chat-time">10:29</div>
							</div>
							<div class="chats-contact">
								<div class="chats-contact-name">Имя</div>
								<div class="chats-contact-status">0</div>
